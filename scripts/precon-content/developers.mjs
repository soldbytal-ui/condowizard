...
export const DEVELOPERS = {
  ...
  'mattamy-homes': {
    displayName: 'Mattamy Homes',
    hq: 'Toronto',
    founded: 1978,
    focus: 'low-rise, mid-rise and master-planned community development across Canada and the United States',
    knownFor: 'the Cornell master-planned community in Markham, Preserve West and North Oakville communities, and multiple GTA townhome and single-family developments',
    portfolioContext: 'Mattamy is one of the largest privately owned homebuilders in North America.',
    relevanceLine: 'The company has extensive experience with master-planned suburban communities and family-oriented product.',
  },
  'liberty-development': {
    displayName: 'Liberty Development',
    hq: 'Vaughan',
    founded: 1987,
    focus: 'high-rise condominium development across the GTA',
    knownFor: 'Cosmos Condos, World on Yonge, Canopy Towers and multiple Mississauga and Vaughan projects',
    portfolioContext: 'Liberty has completed 20+ residential communities across the GTA over more than three decades.',
    relevanceLine: 'The company has repeated experience with transit-oriented condominium projects in the 905 markets.',
  },
  'cortel-group': {
    displayName: 'Cortel Group',
    hq: 'Vaughan',
    founded: 1971,
    focus: 'high-rise condominium, low-rise and industrial development',
    knownFor: 'Expo City in Vaughan Metropolitan Centre, Bellaria in Vaughan and multiple GTA residential communities',
    portfolioContext: 'Cortel is a family-owned developer with a portfolio spanning residential, commercial and industrial real estate.',
    relevanceLine: 'The company has direct experience with Vaughan Metropolitan Centre master-planned communities.',
  },
  'times-group': {
    displayName: 'Times Group',
    hq: 'Richmond Hill',
    founded: 1988,
    focus: 'high-rise and mid-rise condominium development across the GTA',
    knownFor: 'World on Yonge, Riocan Colossus Centre and multiple Vaughan and Markham communities',
    portfolioContext: 'Times Group has completed communities across the GTA over more than three decades.',
    relevanceLine: 'The company has repeated experience with York Region master-planned communities.',
  },
  'the-remington-group': {
    displayName: 'The Remington Group',
    hq: 'Toronto',
    founded: 1955,
    focus: 'commercial, residential and mixed-use development, primarily in the eastern GTA and Markham',
    knownFor: 'Downtown Markham, Buttonville master plan and multiple large-scale mixed-use communities',
    portfolioContext: 'Remington is a family-owned developer with a portfolio focused on large-scale master-planned communities.',
    relevanceLine: 'The company has directly led the Downtown Markham master plan.',
  },
  'the-conservatory-group': {
    displayName: 'The Conservatory Group',
    hq: 'Toronto',
    founded: 1959,
    focus: 'high-rise, mid-rise and low-rise residential development across the GTA',
    knownFor: 'Conservatory Gardens, Beverley Hills and multiple GTA communities',
    portfolioContext: 'Conservatory has completed dozens of residential communities across the GTA over more than six decades.',
    relevanceLine: 'The company has extensive experience across mid-market and upper-mid-market condominium product.',
  },
  'branthaven': {
    displayName: 'Branthaven',
    hq: 'Burlington',
    founded: 1971,
    focus: 'residential low-rise, mid-rise and high-rise development across Halton and Hamilton',
    knownFor: 'Millcroft, Alton Village and multiple Burlington and Hamilton communities',
    portfolioContext: 'Branthaven has been an active developer in the Halton and Hamilton markets for over five decades.',
    relevanceLine: 'The company has direct experience with Halton Region and Hamilton residential communities.',
  },
  'valour-group': {
    displayName: 'Valour Group',
    hq: 'Vaughan',
    founded: 2015,
    focus: 'mid-rise and high-rise residential condominium development',
    knownFor: 'Valera Condos and multiple GTA mid-rise projects',
    portfolioContext: 'Valour is a newer developer with an active pipeline in Halton and Peel regions.',
    relevanceLine: 'As a newer developer, buyers may wish to review construction financing and delivery experience alongside the marketing materials.',
  },
  'brookfield-residential': {
    displayName: 'Brookfield Residential',
    hq: 'Calgary, with Toronto-area operations',
    founded: 1958,
    focus: 'master-planned community, low-rise, mid-rise and high-rise development across North America',
    knownFor: 'Mount Pleasant Village in Brampton, Seaton in Pickering, Saturday in Downsview Park and multiple large master plans',
    portfolioContext: 'Brookfield Residential is part of the Brookfield Asset Management group, one of the largest asset managers in the world.',
    relevanceLine: 'The company has extensive experience with large-scale master-planned communities.',
  },
  'empire-communities': {
    displayName: 'Empire Communities',
    hq: 'Vaughan',
    founded: 1993,
    focus: 'low-rise, mid-rise and high-rise residential development across Canada and the United States',
    knownFor: 'Empire Maverick, Empire Quay House, Empire Wyldewood and multiple GTA and Ontario communities',
    portfolioContext: 'Empire has built over 26,000 homes across North America.',
    relevanceLine: 'The company has repeated experience with mid-rise and high-rise product across the GTA.',
  },
  'in8-developments': {
    displayName: 'IN8 Developments',
    hq: 'Kitchener-Waterloo',
    founded: 2007,
    focus: 'high-rise condominium development in southern Ontario markets',
    knownFor: 'The Barrel Yards in Waterloo, Station Park in Kitchener and multiple Ontario high-rises',
    portfolioContext: 'IN8 has an active pipeline of high-rise projects across secondary Ontario markets.',
    relevanceLine: 'The company has direct experience with high-rise condominium delivery in mid-sized Ontario cities.',
  },
  'greenpark-group': {
    displayName: 'Greenpark Group',
    hq: 'Vaughan',
    founded: 1967,
    focus: 'high-rise, mid-rise and low-rise residential development across the GTA',
    knownFor: 'Tempo Condos, Trinity Ravine Towers, and dozens of GTA low-rise and high-rise communities',
    portfolioContext: 'Greenpark has built over 70,000 homes across the GTA over more than five decades.',
    relevanceLine: 'The company has extensive experience with both mid-market and upper-mid-market residential communities.',
  },
  'edenshaw-developments': {
    displayName: 'Edenshaw Developments',
    hq: 'Mississauga',
    founded: 2011,
    focus: 'mid-rise and high-rise condominium development in Mississauga and the western GTA',
    knownFor: 'The Whitby Condos, Universal City and multiple downtown Mississauga projects',
    portfolioContext: 'Edenshaw focuses on transit-oriented mid-rise and high-rise projects in the western GTA.',
    relevanceLine: 'The company has direct experience with downtown Mississauga and waterfront Port Credit development.',
  },
  'essence-homes': {
    displayName: 'Essence Homes',
    hq: 'Toronto',
    founded: 2004,
    focus: 'mid-rise and high-rise condominium development in Peel Region',
    knownFor: 'Bramalea Square Condos, Two55 Condos and multiple Brampton and Mississauga projects',
    portfolioContext: 'Essence Homes focuses on Peel Region intensification projects.',
    relevanceLine: 'The company has repeated experience with Brampton and Mississauga condominium projects.',
  },
  'national-homes': {
    displayName: 'National Homes',
    hq: 'Vaughan',
    founded: 1993,
    focus: 'low-rise and mid-rise residential development across the GTA',
    knownFor: 'multiple townhome and condominium communities across Brampton, Vaughan and Toronto',
    portfolioContext: 'National Homes has an active pipeline of family-oriented residential communities across the GTA.',
    relevanceLine: 'The company has repeated experience with mid-market family-oriented product.',
  },
  'primont-homes': {
    displayName: 'Primont Homes',
    hq: 'Vaughan',
    founded: 1985,
    focus: 'residential development across the GTA',
    knownFor: 'Vaughan and Brampton communities including Primont Place',
    portfolioContext: 'Primont Homes has been active across York and Peel regions for nearly four decades.',
    relevanceLine: 'The company has repeated experience with York Region and Peel Region residential communities.',
  },
  'solmar-development': {
    displayName: 'Solmar Development',
    hq: 'Vaughan',
    founded: 1988,
    focus: 'high-rise condominium and low-rise residential development across the GTA',
    knownFor: 'The Point at Emerald City, Universal City and multiple GTA high-rises',
    portfolioContext: 'Solmar has an active pipeline of high-rise and low-rise projects across the GTA.',
    relevanceLine: 'The company has repeated experience with high-rise condominium projects in Brampton and Vaughan.',
  },
  'oxford-properties': {
    displayName: 'Oxford Properties',
    hq: 'Toronto',
    founded: 1960,
    focus: 'commercial office, retail and residential development on behalf of OMERS',
    knownFor: 'Yorkdale Shopping Centre, Square One Shopping Centre, Hudson\'s Bay Centre and multiple flagship Canadian properties',
    portfolioContext: 'Oxford Properties is one of North America\'s largest institutional real estate owners and developers.',
    relevanceLine: 'Its residential projects are typically integrated with existing retail flagships under long-term institutional ownership.',
  },
  'diamondcorp': {
    displayName: 'DiamondCorp',
    hq: 'Toronto',
    founded: 2007,
    focus: 'mixed-use urban development across the GTA and Ottawa',
    knownFor: 'Brightwater in Port Credit, The Well in Toronto (in partnership) and multiple downtown Toronto and GTA projects',
    portfolioContext: 'DiamondCorp partners with major institutional and developer groups on large-scale mixed-use master plans.',
    relevanceLine: 'The company has direct experience with large-scale urban master plans.',
  },
  'metropia': {
    displayName: 'Metropia',
    hq: 'Toronto',
  ...
  'smartliving': {
    displayName: 'SmartLiving (SmartCentres)',
    hq: 'Vaughan',
    founded: 1994,
    focus: 'mixed-use residential development on SmartCentres retail-anchored properties',
    knownFor: 'SmartVMC master plan in Vaughan, Millway Condos and multiple Walmart-anchored intensification projects',
    portfolioContext: 'SmartLiving is the residential development arm of SmartCentres REIT, one of Canada\'s largest publicly listed REITs.',
    relevanceLine: 'The company has direct access to a large Walmart-anchored land bank across Canada.',
  },
  'cadillac-fairview': {
