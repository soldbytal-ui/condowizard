...
const FEATURES = ['Practice area landing pages', 'AI intake qualifier', 'Consult scheduling', 'Retainer management', 'Review generation', 'LSRA compliance rules'];
  ...
  return (
    <div style={{ padding: '28px 32px', fontFamily: FB, color: PAPER, maxWidth: 800 }}>
      ...
      <div style={{ textAlign: 'center', padding: '60px 0' }}>
        ...
        <h1 style={{ fontFamily: FH, fontSize: 36, fontWeight: 400, letterSpacing: '-0.03em', margin: '0 0 8px' }}>Legal</h1>
        ...
        <p style={{ fontSize: 14, color: MUTED, lineHeight: 1.6, maxWidth: 500, margin: '0 auto 28px' }}>Practice area targeting, intake qualification, consult booking, case management, and LSRA-compliant advertising.</p>
