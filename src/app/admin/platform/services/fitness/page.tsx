...
const FEATURES = ['Class scheduling', 'Membership management', 'Trial conversion campaigns', 'Retention emails', 'Referral programs', 'Wearable integrations'];
  ...
  return (
    <div style={{ padding: '28px 32px', fontFamily: FB, color: PAPER, maxWidth: 800 }}>
      ...
      <div style={{ textAlign: 'center', padding: '60px 0' }}>
        ...
        <h1 style={{ fontFamily: FH, fontSize: 36, fontWeight: 400, letterSpacing: '-0.03em', margin: '0 0 8px' }}>Fitness &amp; Wellness</h1>
        ...
        <p style={{ fontSize: 14, color: MUTED, lineHeight: 1.6, maxWidth: 500, margin: '0 auto 28px' }}>Membership funnels, class schedules, trial-to-member conversions, and retention campaigns.</p>
