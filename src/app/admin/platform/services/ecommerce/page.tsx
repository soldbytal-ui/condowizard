...
const FEATURES = ['Product feed management', 'Google Shopping ads', 'Meta catalog ads', 'Abandoned cart recovery', 'Upsell campaigns', 'Review collection'];
  ...
  return (
    <div style={{ padding: '28px 32px', fontFamily: FB, color: PAPER, maxWidth: 800 }}>
      ...
      <div style={{ textAlign: 'center', padding: '60px 0' }}>
        ...
        <h1 style={{ fontFamily: FH, fontSize: 36, fontWeight: 400, letterSpacing: '-0.03em', margin: '0 0 8px' }}>E-commerce</h1>
        ...
        <p style={{ fontSize: 14, color: MUTED, lineHeight: 1.6, maxWidth: 500, margin: '0 auto 28px' }}>Product catalog ads, shopping campaigns, retargeting, and conversion optimization.</p>
