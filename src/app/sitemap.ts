...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${baseUrl}/condos`, lastModified: today, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/toronto-houses-for-sale`, lastModified: today, changeFrequency: 'daily', priority: 0.8 },
    { url: `${baseUrl}/toronto-townhomes-for-sale`, lastModified: today, changeFrequency: 'daily', priority: 0.8 },
    { url: `${baseUrl}/toronto-luxury-homes`, lastModified: today, changeFrequency: 'daily', priority: 0.8 },
    { url: `${baseUrl}/staging`, lastModified: today, changeFrequency: 'monthly', priority: 0.6 },
